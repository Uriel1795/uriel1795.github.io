...
CREATE TABLE teams (
    ...
    CONSTRAINT teams_program_valid CHECK (program IN ('VEX IQ', 'VEX V5'))
);
...
CREATE TABLE seasons (
    ...
    CONSTRAINT seasons_program_valid CHECK (program IN ('VEX IQ', 'VEX V5')),
...
CREATE TABLE robots (
    ...
    CONSTRAINT robots_one_per_season UNIQUE (team_id, season_id)
);
